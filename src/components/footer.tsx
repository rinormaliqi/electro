      ...
      <div className="container mx-auto px-4">
        ...
        <div className="py-16">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            {/* Services */}
            <div>
              <h3 className="text-lg font-bold mb-6 text-yellow-400">{t("footer.services")}</h3>
            ...
            {/* Contact */}
            <div>
              <h3 className="text-lg font-bold mb-6 text-yellow-400">{t("footer.contact")}</h3>
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  <Phone className="size-5 text-green-400 mt-0.5 flex-shrink-0" />
                  <span className="text-gray-300 text-sm">+355 69 282 3346</span>
                </div>
                <div className="flex items-start gap-3">
                  <Mail className="size-5 text-green-400 mt-0.5 flex-shrink-0" />
                  <span className="text-gray-300 text-sm">eagreensolar@gmail.com</span>
                </div>
                <div className="flex items-start gap-3">
